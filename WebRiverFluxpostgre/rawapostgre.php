<!DOCTYPE html>
<link rel="stylesheet" type="text/css" href="websungaipostgre.css">
<script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.9.4/Chart.js"></script>
<script src="https://cdn.plot.ly/plotly-latest.min.js"></script>
<html>
    <head>
        <title>RiverFlux | Sungai Krutuk </title>
    ...
    <body>
        ...
        $sqlciliwung = "SELECT sungai.ID,sungai.NamaSungai,flux.waktu, flux.tinggi_air,terpantau.TinggiNormal,terpantau.Area, flux.kecepatan,terpantau.jarak
        FROM ((flux
        ...
        LIMIT 10";
        $result = pg_query($conn, $sqlciliwung);
        ...
        ORDER BY flux.waktu DESC, terpantau.Area
        LIMIT $rowcount";
        $resultjarak = pg_query($conn,$sqljarak);
        ...
        <div class="isi">
            <div class="info">       
                ...
                <table class="tablekondisi">
                    ...
                    <?php while($row = pg_fetch_object($resultjarak)){
...
<script>
    var xValues = ["Tidak Banjir", "Banjir"];
    var yValues = [75, 25];
    var barColors = [
        "green",
        "red",
    ...
    var xValues1 = ["Tidak Banjir", "Banjir"];
    var yValues1 = [15, 85];
    var barColors = [
        "green",
        "red",
    ...
    new Chart("myChart", {
        ...
        options: {
            title: {
                display: true,
                text: "Kemungkinan terjadi banjir hari ini"
            }
        }
    });
